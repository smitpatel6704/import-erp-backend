...
const schemaIdentifiers = [
    ...
    'emailStatus', 'expiryDate', 'expiryRequired', 'exporterCompany', 'exporterCompanyId', 'fileSize', 'fileType',
    ...
    'originCountry', 'originPort', 'packingType', 'paidAmount', 'panNumber', 'paymentDate', 'permissions',
